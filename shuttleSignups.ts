// convex/shuttleSignups.ts
// Drop this file directly into your convex/ folder.
// After adding the schema table from schema.addition.ts, run `npx convex dev`
// to regenerate types and deploy.
